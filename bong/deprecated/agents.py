...
import pandas as pd
from bong.util import unsafestr
...
AGENT_DICT_MC = {
    ...
    "bong_fc_mom": {
        "constructor": bong.fg_reparam_bong,
        "lr": 0,
        "niter": 0,
        "nsample": None,
        "linplugin": 0,
    ...
    "bong_diag_mom": {
        "constructor": bong.dg_reparam_bong,
        "lr": 0,
        "niter": 0,
        "nsample": None,
        "linplugin": 0,
    ...
    "blr_fc_mom": {
        "constructor": blr.fg_reparam_blr,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
    ...
    "blr_diag_mom": {
        "constructor": blr.dg_reparam_blr,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
    ...
    "bog_fc_mom": {
        "constructor": bog.fg_reparam_bog,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
    ...
    "bog_diag_mom": {
        "constructor": bog.dg_reparam_bog,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
    ...
    "bbb_fc_mom": {
        "constructor": bbb.fg_reparam_bbb,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
    ...
    "bbb_diag_mom": {
        "constructor": bbb.dg_reparam_bbb,
        "lr": None,
        "niter": None,
        "nsample": None,
        "linplugin": 0,
...
AGENT_DICT_LIN = {
    f"{agent}_lin": convert_to_linplugin(args)
    for (agent, args) in AGENT_DICT_MC.items()
}
