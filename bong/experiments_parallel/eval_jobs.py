...
def create_eval_df(args):
    nll_val_results = extract_results(
        args.dir, "nlpd-pi_val_mean", args.jobs_file, args.jobs_suffix
    )
    nlpd_val_results = extract_results(
        args.dir, "nlpd-mc_val_mean", args.jobs_file, args.jobs_suffix
    )
